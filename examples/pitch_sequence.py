...
def pitch_sequence_detection():
    ...
    model = ConstrainedPitchSequenceModel(np.array([g4_spec, c5_spec]), 1.4)
    ...
    export_subsequences(reported_subsequences, fs, n_fft // 4, '../examples/results/pitch_sequence.lab')
